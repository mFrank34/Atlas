...
public class Panel {
    ...
    public static JPanel createBasicInfoPanel(JTextField[] fields) {
        ...
        JPanel panel = factory.Component.createTitledPanel("Basic Information", new GridLayout(4, 4, 10, 10));
    ...
    public static JPanel createAbilityScoresPanel(JTextField[] scoreFields, JLabel[] modLabels) {
        ...
        JPanel panel = factory.Component.createTitledPanel("Ability Scores", new GridLayout(1, 6, 10, 10));

        for (int i = 0; i < 6; i++) {
            panel.add(factory.Component.createAbilityScorePanel(abilityNames[i], scoreFields[i], modLabels[i]));
        }
    ...
    public static JPanel createCombatStatsPanel(JTextField[] fields) {
        ...
        JPanel panel = factory.Component.createTitledPanel("Combat Stats", new GridLayout(2, 10, 10, 10));
    ...
    public static JPanel createSkillsPanel(JCheckBox[] checkboxes, JLabel[] modifiers, String[] skillNames) {
        JPanel panel = factory.Component.createTitledPanel("Skills", new GridLayout(skillNames.length, 1, 5, 5));

        for (int i = 0; i < skillNames.length; i++) {
            panel.add(factory.Component.createSkillRow(checkboxes[i], modifiers[i], skillNames[i]));
        }
    ...
    public static JPanel createSavingThrowsPanel(JCheckBox[] checkboxes, JLabel[] modifiers) {
        ...
        JPanel panel = factory.Component.createTitledPanel("Saving Throws", new GridLayout(7, 1, 5, 5));

        for (int i = 0; i < 6; i++) {
            panel.add(factory.Component.createSavingThrowRow(checkboxes[i], modifiers[i], saveNames[i]));
        }
    ...
    public static JPanel createPersonalityPanel(JTextArea[] textAreas) {
        ...
        for (int i = 0; i < 4; i++) {
            panel.add(factory.Component.createTitledTextArea(titles[i], textAreas[i], 5, 20));
        }
    ...
    public static JPanel createSpellcastingInfoPanel(JTextField[] fields) {
        ...
        JPanel panel = factory.Component.createTitledPanel("Spellcasting", new GridLayout(2, 4, 10, 10));
